                    ...
                    {registering ? (
                        ...
                        <>
                            ...
                            <p className="text-xs sm:text-md text-gray-700">
                                Welcome to the CodeDrive family! You're just minutes away from having a space to store all of your most used (and often forgot) coding stuff.
                            </p>
                            <p className="text-xs sm:text-md text-gray-700">
                                Don't forget to tell your friends so you can take advantage of Snippet Sharing in your <strong>CodeDrive</strong>. Sharing is caring!
                            </p>
                        </>
                    )}
                    {registering ? (
