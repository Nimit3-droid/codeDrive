...
export default function View({friendFilter, setFriendFilter}) {
    ...
    return (
        <div className="mt-4 sm:mt-0 sm:ml-2">
            ...
            {
                friendSnippetData.length > 0 ? <div className="grid gap-5 sm:gap-10 mt-6 sm:mt-8 sm:pr-8 grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3">
