...
export default function DeleteProfile() {
	...
	return (
		<div className="space-y-8 tracking-wide mr-8">
			...
			<p>If there is anything we could have done better at <strong className="tracking-widest font-black">CodeDrive</strong>, please <Link className="underline" to="#">let us know</Link>!</p>
