      ...
      {userData.folders.length ? (
        <>
          ...
          <div className="ml-5 sm:ml-1 my-4 flex justify-start items-center relative">
            ...
            {search ? (
              <span
                className="cursor-pointer ml-3 text-xs"
                onClick={handleClear}
              >
                Clear
              </span>
        ...
        <div>
          ...
          <h3 className="text-lg font-light mt-8 ml-8">
            A small message from the creator of CodeDrive:
          </h3>
          <p className="text-md font-light mt-8 mx-8">
            Thank you for joining the CodeDrive!
          </p>
          <p className="text-md font-light mt-8 mx-8">
            I created CodeDrive because it's something that I found myself
            needing so I hope you find it useful as well. With that in mind, it's quite possible I
            may run into bugs in this journey of buiilding this amazing CODEDRIVE. If you do,
            please{" "}
            <a
              className="hover:text-red-600 underline"
              href="https://github.com/Nimit3-droid/codeDrive/issues"
              target="_blank"
            ...
            <a
              className="hover:text-red-600 underline"
              href="mailto:nimitkhanna844@gmail.com"
            >
              nimitkhanna844@gmail.com
            </a>
            .
          </p>
