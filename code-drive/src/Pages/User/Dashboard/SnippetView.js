    ...
    return (
        <div className="sm:ml-2">
            {userData.folders.length ?
                ...
                : <div>
                    <h1 className="text-xl font-bold mt-2 ml-8">Welcome to CodeDrive!</h1>
                    <h3 className="text-lg font-light mt-8 ml-8">A message from the creator of CodeDrive:</h3>
                    <p className="text-md font-light mt-8 mx-8">Thank you for joining the CodeDrive community!</p>
                    <p className="text-md font-light mt-8 mx-8">I created CodeDrive because it's something that I found myself needing so I hope you find it useful as well. It was actually created as a capstone project for a software engineering immersive program I was a part of. With that in mind, it's quite possible you may run into bugs in this infancy period of CodeDrive. If you do, please <a className="hover:text-red-600 underline" href="https://github.com/Nimit3-droid/codeDrive/issues" target="_blank" rel="noopener noreferrer">create an issue on Github</a> or send me an email with any feedback at <a className="hover:text-red-600 underline" href="mailto:nimitkhanna844@gmail.com">nimitkhanna844@gmail.com</a>.
                    </p>
                    <p className="text-md font-light mt-8 ml-8">Now, get started by creating your first Snippet!</p>
                    <h3 className="text-lg font-light mt-8 ml-8">-Nimit</h3>
                </div>
            }
